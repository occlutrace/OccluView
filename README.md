...
Windows installers and binaries are Authenticode-signed when a certificate is
configured. All release artifacts are covered by the checksums, minisign
signatures, and GitHub build provenance described below.

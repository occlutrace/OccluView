...
help-hint-align-measure-end-a-ruler-on-a-ruler-line = Tras el primer punto, terminar la regla sobre una línea de medición; ese extremo se arrastra a lo largo de la línea
help-hint-align-measure-switch-between-any-angle-and-90 = Alternar entre cualquier ángulo y 90° respecto a la línea
...
measure-to-line = Hasta la línea: { $len }, ángulo { $angle }
measure-line-angle = Extremo sobre una línea
measure-line-angle-free = Cualquier ángulo
measure-line-angle-right = 90°
measure-line-angle-hint = Cómo una regla se encuentra con la línea de medición de otra. Con cualquier ángulo, el extremo queda donde hace clic en la línea y se muestra el ángulo; a 90° es el pie de la perpendicular.
measure-line-angle-shift = cambia mientras se mantiene

...
help-hint-align-measure-end-a-ruler-on-a-ruler-line = Après le premier point, terminer la règle sur une ligne de mesure ; cette extrémité glisse le long de la ligne
help-hint-align-measure-switch-between-any-angle-and-90 = Basculer entre angle libre et 90° par rapport à la ligne
...
measure-to-line = Jusqu’à la ligne : { $len }, angle { $angle }
measure-line-angle = Extrémité sur une ligne
measure-line-angle-free = Angle libre
measure-line-angle-right = 90°
measure-line-angle-hint = Comment une règle rejoint la ligne de mesure d’une autre. Avec un angle libre, l’extrémité se place là où vous cliquez sur la ligne et l’angle est affiché ; à 90°, c’est le pied de la perpendiculaire.
measure-line-angle-shift = bascule tant que la touche est maintenue

...
help-hint-align-measure-end-a-ruler-on-a-ruler-line = После первой точки закончить линейку на линии другой линейки; этот конец можно тянуть вдоль линии
help-hint-align-measure-switch-between-any-angle-and-90 = Переключить: любой угол или 90° к линии
...
measure-to-line = До линии: { $len }, угол { $angle }
measure-line-angle = Конец на линии
measure-line-angle-free = Любой угол
measure-line-angle-right = 90°
measure-line-angle-hint = Как линейка встречает линию другой линейки. С любым углом конец встаёт туда, где вы щёлкнули на линии, и показывается угол; при 90° это основание перпендикуляра.
measure-line-angle-shift = пока зажат — другой вариант
